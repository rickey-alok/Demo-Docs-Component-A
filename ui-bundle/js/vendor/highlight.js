(() => {
  ...
  function b(e) {
    var n = "[A-Za-z_\\u00A1-\\uFFFF][A-Za-z_0-9\\u00A1-\\uFFFF]*",
      ...
      t = { className: "subst", begin: /\$\(/, end: /\)/, keywords: t },
  ...
  (D = function (t) {
    ...
    function A(n, e, t, a) {
      ...
      function r() {
        ...
        for (
          a = "", _.lexemesRe.lastIndex = e = 0, n = _.lexemesRe.exec(E);
          n;
      ...
      function l() {
        ...
        (p +=
          null != _.subLanguage
            ? (n = "string" == typeof _.subLanguage) && !w[_.subLanguage]
              ? S(E)
              : ((e = n
                  ? A(_.subLanguage, E, !0, b[_.subLanguage])
                  : k(E, _.subLanguage.length ? _.subLanguage : void 0)),
                0 < _.relevance && (N += e.relevance),
                n && (b[_.subLanguage] = e.top),
          ...
          for (
            e.skip
              ...
              : (e.returnEnd || e.excludeEnd || (E += n),
                ...
                e.excludeEnd && (E = n));
            _.className && (p += O),
              _.skip || _.subLanguage || (N += _.relevance),
              (_ = _.parent) !== a.parent;
      ...
      if (!m)
        throw (
          (console.error(C.replace("{}", n)),
          new Error('Unknown language: "' + n + '"'))
        );
      T(m);
      for (var _ = a || m, b = {}, p = "", f = _; f !== m; f = f.parent)
        f.className && (p = s(f.className, "", !0) + p);
      var E = "",
        N = 0;
      try {
        for (var h, y, v = 0; ; ) {
          if (((_.terminators.lastIndex = v), !(h = _.terminators.exec(i))))
            break;
          (y = u(i.substring(v, h.index), h)), (v = h.index + y);
        }
        for (u(i.substr(v)), f = _; f.parent; f = f.parent)
          f.className && (p += O);
    ...
    function N(e) {
      ...
      c(s) ||
        ...
        (n = s ? A(s, t, !0) : k(t)),
        (a = m(a)).length &&
          (((i = document.createElement("div")).innerHTML = n.value),
          (n.value = _(a, m(i), t))),
        (n.value = E(n.value)),
        (e.innerHTML = n.value),
        (e.className =
    ...
    I.registerLanguage("javascript", m),
    I.registerLanguage("json", _),
    I.registerLanguage("julia", b),
    I.registerLanguage("kotlin", p),
    I.registerLanguage("lua", f),
    I.registerLanguage("markdown", E),
    I.registerLanguage("nix", N),
    I.registerLanguage("none", h),
    I.registerLanguage("objectivec", y),
    I.registerLanguage("perl", v),
    I.registerLanguage("php", w),
    I.registerLanguage("properties", M),
    I.registerLanguage("puppet", O),
    I.registerLanguage("python", C),
    I.registerLanguage("ruby", x),
    I.registerLanguage("rust", S),
    I.registerLanguage("scala", T),
    I.registerLanguage("shell", A),
    I.registerLanguage("sql", k),
    I.registerLanguage("swift", R),
    I.registerLanguage("xml", B),
    I.registerLanguage("yaml", U),
    [].slice
